...
public class AkPluginActivator
{
	...
	private class StaticPluginRegistration
	{
		...
		public void TryWriteToFile()
		{
			...
			CppText += "#define AK_STATIC_LINK_PLUGIN(_pluginName_) \n";
			CppText += "extern AK::PluginRegistration _pluginName_##Registration;";
			CppText += "void *_pluginName_##_fp = (void*)&_pluginName_##Registration;\n\n";
