...
namespace NaughtyAttributes.Editor
{
	...
	public class NaughtyInspector : UnityEditor.Editor
	{
		...
		protected virtual void OnEnable()
		{
			...
			EditorApplication.update += CallOnEditorUpdate;
		}
		...
		protected void CallOnEditorUpdate()
        {
			if (target && Application.isPlaying == false && target is IEditorUpdatable behaviour)
			{
				behaviour.OnEditorUpdate();
			}
        }
